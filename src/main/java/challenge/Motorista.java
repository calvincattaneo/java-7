...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withPontos(int pontos) {
            ...
            if (pontos > 21) throw new EstacionamentoException("Motorista não pode ter mais de 21 pontos");
            this.pontos = pontos;
            return this;
        }
        ...
        public Motorista build() {
            ...
            if (idade < 18) throw new EstacionamentoException("Motorista não pode ser menor de idade");
